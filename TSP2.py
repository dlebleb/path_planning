...
for vline in valid_lines:
    ...
    # --- 3) Yoksa: tekrar corner'lara kır ---
    for rect in hit_rects:
        idx = rect_obstacles.index(rect)
        expanded = expanded_rects[idx]
...
# valid_lines: engeli dolanan iyi adaylar
...
# valid_lines2: ikinci adımda üretilen line'lar
...
# valid_lines2'den sadece 0. elemanı çiz
if len(valid_lines2) > 0:
    line = valid_lines2[3]
